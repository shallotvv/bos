	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v==true){
				...
				var url="{pageContenxt.request.contextPath}/userAction_editPassword.action";
				if(v1==v2){
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <form id="editPasswordFrom">
	                <table cellpadding=3>
	                    <tr>
	                        <td>新密码：</td>
	                        <td><input id="txtNewPass" type="Password" class="txt01 easyui-validatebox" required="true"validType="length[4,10]" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input id="txtRePass" type="Password" class="txt01 easyui-validatebox" required="true"validType="length[4,10]" /></td>
	                    </tr>
	                </table>
                </form>
            </div>
